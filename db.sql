...
CREATE TABLE `customer` (
  ...
  `published_on` varchar(45) NOT NULL,
  `customer_type_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_customertype` (`customer_type_id`),
  CONSTRAINT `fk_customertype` FOREIGN KEY (`customer_type_id`) REFERENCES `customertype` (`customer_type_id`)
...
INSERT INTO `customertype` VALUES (1,'New Customer'),(2,'Returning Customer'),(3,'VIP Customer');
...
-- Dump completed on 2017-01-27  2:27:46
